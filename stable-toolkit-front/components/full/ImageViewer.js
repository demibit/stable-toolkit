...
const ImageViewer = ({ setCurrentPage }) => {
  ...
  const getImages = () => {
    ...
    if (
      !isNullOrUndefined(selectedFilters.location) &&
      selectedFilters.location.length > 0
    ) {
      query.location = selectedFilters.location;
    }

    if (
      !isNullOrUndefined(selectedFilters.tags) &&
    ...
    if (
      selectedFilters.steps !== defaultSelectedFilters.steps &&
      !isNullOrUndefined(selectedFilters.steps) &&
      selectedFilters.steps.length > 0
    ) {
      query.steps = selectedFilters.steps;
    }

    if (
      !isNullOrUndefined(selectedFilters.sampler) &&
      selectedFilters.sampler.length > 0
    ) {
      query.sampler = selectedFilters.sampler;
    }

    if (
      selectedFilters.denoise !== defaultSelectedFilters.denoise &&
      !isNullOrUndefined(selectedFilters.denoise) &&
      selectedFilters.denoise.length > 0
    ) {
      query.denoise = selectedFilters.denoise;
    }

    if (
      selectedFilters.cfg !== defaultSelectedFilters.cfg &&
      !isNullOrUndefined(selectedFilters.cfg) &&
      selectedFilters.cfg.length > 0
    ) {
      query.cfg = selectedFilters.cfg;
    }

    if (
      !isNullOrUndefined(selectedFilters.modelHash) &&
      selectedFilters.modelHash.length > 0
    ) {
      query.modelHash = selectedFilters.modelHash;
    }

    if (
      !isNullOrUndefined(selectedFilters.modelName) &&
      selectedFilters.modelName.length > 0
    ) {
      query.modelName = selectedFilters.modelName;
    }

    if (
      !isNullOrUndefined(selectedFilters.faceRestoration) &&
      selectedFilters.faceRestoration.length > 0
    ) {
      query.faceRestoration = selectedFilters.faceRestoration;
    }

    if (
      !isNullOrUndefined(selectedFilters.hypernet) &&
      selectedFilters.hypernet.length > 0
    ) {
      query.hypernet = selectedFilters.hypernet;
    }

    if (
      selectedFilters.clipSkip !== defaultSelectedFilters.clipSkip &&
      !isNullOrUndefined(selectedFilters.clipSkip) &&
      selectedFilters.clipSkip.length > 0
    ) {
      query.clipSkip = selectedFilters.clipSkip;
    }

    if (
      selectedFilters.width !== defaultSelectedFilters.width &&
      !isNullOrUndefined(selectedFilters.width) &&
    ...
    if (
      selectedFilters.height !== defaultSelectedFilters.height &&
      !isNullOrUndefined(selectedFilters.height) &&
    ...
    if (
      !isNullOrUndefined(selectedFilters.afterDate) &&
      selectedFilters.afterDate.length > 0
    ) {
      query.afterDate = new Date(selectedFilters.afterDate).toISOString();
    }

    if (
      !isNullOrUndefined(selectedFilters.beforeDate) &&
      selectedFilters.beforeDate.length > 0
    ) {
  ...
  return (
    <StyledBox>
      ...
      <GenericDrawer open={showSettingsDrawer}>
        <TitleListItem>
          <ListItemText>
            <Typography>Images currently displayed: {images.length}</Typography>
          </ListItemText>
        </TitleListItem>
          ...
          <Fragment>
            ...
            <ListItem>
              <ListItemButton onClick={() => putFolders()}>
                <TypographyCenter>Add</TypographyCenter>
              </ListItemButton>
            </ListItem>
          </Fragment>
        )}
        ...
        {selectedTagGroup === "delete" && (
          <ListItem>
            <TextField select value={""} label={"Tags"} fullWidth>
        ...
        <ListItemButton onClick={(e) => reIndex(e)}>
          <TypographyCenter>Re-Index</TypographyCenter>
        </ListItemButton>
      ...
      <GenericDrawer open={showFiltersDrawer}>
        {Object.keys(possibleFilters).length === 0 ? (
          <TitleListItem>
            <ListItemText>
              <TypographyCenter>
                No parameters found to filter by
              </TypographyCenter>
            </ListItemText>
          </TitleListItem>
        ) : (
          <TitleListItem>
            <ListItemText>
              <TypographyCenter>Filters</TypographyCenter>
            </ListItemText>
          </TitleListItem>
        )}

        <Divider />
        {!isNullOrUndefined(possibleFilters.location) && (
          <Fragment>
            <ListItem>
              <TextField
                select
                ...
                fullWidth
              >
                {possibleFilters.location.map((option, index) => (
                  <MenuItem key={index} value={option.name}>
                    <Checkbox
                      checked={selectedFilters.location
                        .map((f) => f.name)
        ...
        {!isNullOrUndefined(possibleFilters.tags) && (
          <Fragment>
            <ListItem>
              <TextField
                select
                ...
                value={""}
                onChange={(e) => {
                  if (selectedFilters.tags.find((f) => f === e.target.value)) {
                    setSelectedFilters({
                      ...selectedFilters,
              ...
              >
                {possibleFilters.tags.map((option, index) => (
                  <MenuItem key={index} value={option}>
                    <Checkbox checked={selectedFilters.tags.includes(option)} />
        ...
        {!isNullOrUndefined(possibleFilters.steps) && (
          <Fragment>
            <ListItem>
              <ListItemText>
                <Typography>
                  Sample steps: {Math.min(...selectedFilters.steps)}-
                  {Math.max(...selectedFilters.steps)}
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
              <Slider
                value={selectedFilters.steps}
        ...
        {!isNullOrUndefined(possibleFilters.sampler) && (
          <Fragment>
            <ListItem>
              <TextField
                select
                ...
                onChange={(e) => {
                  if (
                    selectedFilters.sampler.find((f) => f === e.target.value)
                  ) {
                    setSelectedFilters({
                      ...selectedFilters,
                    ...
                    setSelectedFilters({
                      ...selectedFilters,
                      sampler: [
                        ...selectedFilters.sampler,
                        possibleFilters.sampler.find(
                          (f) => f === e.target.value
                        ),
                      ],
                    });
              ...
              >
                {possibleFilters.sampler.map((option, index) => (
                  <MenuItem key={index} value={option}>
                    <Checkbox
                      checked={selectedFilters.sampler.includes(option)}
                    />
                    <Typography>{option}</Typography>
                  </MenuItem>
                ))}
        ...
        {!isNullOrUndefined(possibleFilters.denoise) && (
          <Fragment>
            <ListItem>
              <ListItemText>
                <Typography>
                  Denoise: {Math.min(...selectedFilters.denoise)}-
                  {Math.max(...selectedFilters.denoise)}
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
              <Slider
                value={selectedFilters.denoise}
                valueLabelDisplay="off"
                onChange={(e) =>
                  setSelectedFilters({
                    ...selectedFilters,
                    denoise: e.target.value,
                  })
                }
        ...
        {!isNullOrUndefined(possibleFilters.cfg) && (
          <Fragment>
            <ListItem>
              <ListItemText>
                <Typography>
                  CFG: {Math.min(...selectedFilters.cfg)}-
                  {Math.max(...selectedFilters.cfg)}
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
              <Slider
                value={selectedFilters.cfg}
                valueLabelDisplay="off"
                onChange={(e) =>
                  setSelectedFilters({
                    ...selectedFilters,
        ...
        {!isNullOrUndefined(possibleFilters.modelHash) && (
          <Fragment>
            <ListItem>
              <TextField
                select
                ...
                onChange={(e) => {
                  if (
                    selectedFilters.modelHash.find((f) => f === e.target.value)
                  ) {
                    setSelectedFilters({
                      ...selectedFilters,
              ...
              >
                {possibleFilters.modelHash.map((option, index) => (
                  <MenuItem key={index} value={option}>
                    <Checkbox
                      checked={selectedFilters.modelHash.includes(option)}
                    />
                    <Typography>{option}</Typography>
                  </MenuItem>
                ))}
        ...
        {!isNullOrUndefined(possibleFilters.modelName) && (
          <ListItem>
            <TextField
              select
              label="Model"
              ...
              onChange={(e) => {
                if (
                  selectedFilters.modelName.find((f) => f === e.target.value)
                ) {
                  setSelectedFilters({
                    ...selectedFilters,
            ...
            >
              {possibleFilters.modelName.map((option, index) => (
                <MenuItem key={index} value={option}>
                  <Checkbox
                    checked={selectedFilters.modelName.includes(option)}
                  />
                  <Typography>{option}</Typography>
                </MenuItem>
              ))}
        ...
        {!isNullOrUndefined(possibleFilters.faceRestoration) && (
          <Fragment>
            <ListItem>
              <TextField
                select
                ...
                onChange={(e) => {
                  if (
                    selectedFilters.faceRestoration.find(
                      (f) => f === e.target.value
                    )
                  ) {
                    setSelectedFilters({
                    ...
                    setSelectedFilters({
                      ...selectedFilters,
                      faceRestoration: [
                        ...selectedFilters.faceRestoration,
              ...
              >
                {possibleFilters.faceRestoration.map((option, index) => (
                  <MenuItem key={index} value={option}>
                    <Checkbox
                      checked={selectedFilters.faceRestoration.includes(option)}
                    />
                    <Typography>{option}</Typography>
                  </MenuItem>
                ))}
        ...
        {!isNullOrUndefined(possibleFilters.hypernet) && (
          <Fragment>
            <ListItem>
              <TextField
                select
                ...
                onChange={(e) => {
                  if (
                    selectedFilters.hypernet.find((f) => f === e.target.value)
                  ) {
                    setSelectedFilters({
                      ...selectedFilters,
              ...
              >
                {possibleFilters.hypernet.map((option, index) => (
                  <MenuItem key={index} value={option}>
                    <Checkbox
                      checked={selectedFilters.hypernet.includes(option)}
                    />
                    <Typography>{option}</Typography>
                  </MenuItem>
                ))}
        ...
        {!isNullOrUndefined(possibleFilters.clipSkip) && (
          <Fragment>
            <ListItem>
              <ListItemText>
                <Typography>
                  Clip skip: {Math.min(...selectedFilters.clipSkip)}-
                  {Math.max(...selectedFilters.clipSkip)}
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
              <Slider
                value={selectedFilters.clipSkip}
                valueLabelDisplay="off"
                onChange={(e) =>
                  setSelectedFilters({
                    ...selectedFilters,
                    clipSkip: e.target.value,
                  })
                }
        ...
        {!isNullOrUndefined(possibleFilters.width) && (
          <Fragment>
            <ListItem>
              <ListItemText>
                <Typography>
                  Width: {Math.min(...selectedFilters.width)}-
                  {Math.max(...selectedFilters.width)}
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
        ...
        {!isNullOrUndefined(possibleFilters.height) && (
          <Fragment>
            <ListItem>
              <ListItemText>
                <Typography>
                  Height: {Math.min(...selectedFilters.height)}-
                  {Math.max(...selectedFilters.height)}
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
        ...
        {!isNullOrUndefined(possibleFilters.afterDate) && (
          <Fragment>
            <ListItem>
              <TextField
                fullWidth
                ...
                label="Images after"
                type="datetime-local"
                value={selectedFilters.afterDate.slice(0, 16)}
                onChange={(e) =>
                  setSelectedFilters({
                    ...selectedFilters,
        ...
        {!isNullOrUndefined(possibleFilters.beforeDate) && (
          <Fragment>
            <ListItem>
              <TextField
                fullWidth
                ...
                label="Images before"
                type="datetime-local"
                value={selectedFilters.beforeDate.slice(0, 16)}
                onChange={(e) =>
                  setSelectedFilters({
                    ...selectedFilters,
        ...
        <Divider />
        <ListItemButton onClick={(e) => getImages()}>
          <TypographyCenter>Filter</TypographyCenter>
        </ListItemButton>
        <Divider />
        <ListItemButton
      ...
      {selectedImages.length > 0 && (
        <FilterFab fromBot={0} fromLeft={3} variant={"extended"}>
          <TextField
            select
            size={"small"}
            value={""}
              ...
              <CenterGrid item xs={6}>
                ...
                <Grid item>
                  <TextFieldMargin
                    ...
                    multiline
                    value={
                      imageToDisplay.positivePrompt !== null
                ...
                <Grid item>
                  <TextFieldMargin
                    ...
                    multiline
                    value={
                      imageToDisplay.negativePrompt !== null
                        ...
                        ? Object.entries(imageToDisplay)
                            .filter(
                              (k) =>
                                ...
                                k[0] !== "creationDate" &&
                                k[0] !== "tags"
                            ) // TODO Refactor to make it not look like it was written by a 5 year old
                            .map((k, i) => {
                              const space = i !== 0 ? " " : "";
                ...
                >
                  {imageToDisplay &&
                    imageToDisplay.tags.sort().map((data, index) => (
                      <Grid item key={index}>
                        <ListItem>
                          <Chip label={data} />
                        </ListItem>
